...
# log and checkpoint
out_dir = Path('cache')
save_dir = out_dir/'ckpts_source_b0'/this_task
...
def main():
    ...
    ckpt = torch.load('./cache/ckpts_source_b0/OS-MN40_2022-02-27-17-29-38/ckpt_F.pth')
    netF.load_state_dict(ckpt['net'])
    netF = netF.cuda()
    netF = nn.DataParallel(netF)

    netC = UniModel_cls(n_class)
    ckpt = torch.load('./cache/ckpts_source_b0/OS-MN40_2022-02-27-17-29-38/ckpt_C.pth')
